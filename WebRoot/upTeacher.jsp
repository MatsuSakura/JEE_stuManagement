...
<body>
	<div class="layui-fluid">
		<div class="layui-row">
			<form class="layui-form" action="./UpTeacher" method="post">

				<div class="layui-form-item">
					<div class="layui-input-inline">
						<input type="hidden" id="number" name="number" class="layui-input"
							value="${teacher.id }">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<c:choose>
						<c:when test="${teacher.gender=='男' }">
							<div class="layui-input-block">
								<input name="gender" value="男" type="radio" title="男"
									checked="checked"> <input name="gender" value="女"
									type="radio" title="女">
							</div>
						</c:when>
						<c:otherwise>
							<div class="layui-input-block">
								<input name="gender" value="男" type="radio" title="男"> <input
									name="gender" value="女" type="radio" title="女"
									checked="checked">
							</div>
						</c:otherwise>
					</c:choose>
